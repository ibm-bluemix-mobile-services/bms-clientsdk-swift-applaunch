...
SWIFT_MODULE_NAMESPACE_PUSH("AppLaunch")

SWIFT_CLASS("_TtC9AppLaunch9AppLaunch")
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) AppLaunch * _Nonnull sharedInstance;)
+ (AppLaunch * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
- (void)initializeWithAppGUIDWithApplicationId:(NSString * _Nonnull)applicationId clientSecret:(NSString * _Nonnull)clientSecret region:(NSString * _Nonnull)region;
...
@interface UIDevice (SWIFT_EXTENSION(AppLaunch))
