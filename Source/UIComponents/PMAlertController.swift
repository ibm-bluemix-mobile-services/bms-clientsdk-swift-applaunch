...
@objc internal enum PMAlertControllerStyle : Int {
...
internal extension PMAlertController {
...
@objc internal class PMAlertController: UIViewController {
    ...
    //MARK: - Initialiser
    @objc internal convenience init(title: String, description: String, image: UIImage?, style: PMAlertControllerStyle) {
        self.init()
    ...
    //MARK: - Actions
    @objc internal func addAction(_ alertAction: PMAlertAction){
